# Simple-Python-Form-Submission-App
This project showcases how to process user input — such as name, email, and message — securely without a database or external dependencies. It’s perfect for beginners learning Python Flask form submission.
| Category             | Technology / Tool              | Purpose                               |
| -------------------- | ------------------------------ | ------------------------------------- |
| **Language**         | Python 3.8+                    | Backend scripting and form processing |
| **Framework**        | Flask                          | Web framework for Python              |
| **Frontend**         | HTML5, CSS3                    | Form UI and styling                   |
| **Runtime Option**   | Python Built-in Server         | Local development                     |
